        ...
        Entity entity)
    {
        ...
        else
        {
            ...
            else if (spaceLeftInBackpack <= 0)
            {
                ...
                ECB.SetComponent(entity, new Target { Position = stats.HivePosition + new float3(0, 1, 0) });
            }
        }
    }
}
